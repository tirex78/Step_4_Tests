...
let UsersService = class UsersService {
    ...
    async getUsers(offset, limit, startId, options) {
        const where = {};
        let separateCount = 0;
        if (startId) {
        ...
        const [items, count] = await this.usersRepository.findAndCount(Object.assign({ where, order: {
                id: 'ASC',
    ...
    async updateUser(userId, updateUserDto) {
        ...
        if (!result.affected) {
            throw new common_1.HttpException('User with this id was not found', common_1.HttpStatus.NOT_FOUND);
        }
        return {
