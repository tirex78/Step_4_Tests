...
exports.LocalFilesInterceptor = void 0;
...
function LocalFilesInterceptor(options) {
    let Interceptor = class Interceptor {
        constructor(configService) {
            ...
            this.fileInterceptor = new ((0, platform_express_1.FilesInterceptor)(options.fieldName, options.maxFiles, multerOptions))();
        }
        intercept(...args) {
...
exports.LocalFilesInterceptor = LocalFilesInterceptor;
